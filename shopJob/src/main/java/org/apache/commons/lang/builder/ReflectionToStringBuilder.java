...
public class ReflectionToStringBuilder extends ToStringBuilder {
     ...
     * entries. Note that {@link java.util.Arrays#sort(Object[])} will throw an {@link NullPointerException} if an array element
     * is <code>null</code>.
     * 
     * @param collection
     ...
     * (arrays and collections). Note that {@link java.util.Arrays#sort(Object[])} will throw an {@link NullPointerException}
