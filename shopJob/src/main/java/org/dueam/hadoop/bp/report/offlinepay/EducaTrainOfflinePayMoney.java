//===================================================================================
// Copyright (c) 2004-2013 by www.taobao.com, All rights reserved.
...
//===================================================================================
// File name: EducaTrainOfflinePayMoney.java
// Author: longque.zs
// Date: 2013-2-18 下午04:04:21 
// Description: 	 
// 		无
// Function List: 	 
// 		1. 无
...
/**
 * 线下支付-教育培训类目pos刷卡金额(包括婴幼儿教育(50026361)、少儿培训(50026363)、中小学教育(50008155)、教育机构线下活动(50050571))
 * @author longque.zs
 * @version 1.0
 **/

public class EducaTrainOfflinePayMoney {

	private static char CTRL_A=(char)0x01; //分隔符

	/**
	 * 主要内容：
	 * 教育培训类目线上小定成交排行榜(每天)：卖家用户名和宝贝id分组  筛选内容：卖家用户名、商品id、成交笔数、支付宝成交金额
	 * 教育培训类目线下POS大定成交排行榜(每天)：卖家用户名和宝贝id分组  筛选内容：卖家用户名、商品id、成交笔数、支付宝成交金额
	 * 教育培训类目2012年线上小定成交排行榜(每年)：卖家用户名分组  筛选内容：卖家用户名、成交笔数、支付宝成交金额
	 * 教育培训类目2012年线下POS大定成交排行榜(每年)：卖家用户名分组  筛选内容：卖家用户名、成交笔数、支付宝成交金额
	 * 教育培训类目2013年线上小定成交排行榜(每年)：卖家用户名分组  筛选内容：卖家用户名、成交笔数、支付宝成交金额
	 * 教育培训类目2013年线下POS大定成交排行榜(每年)：卖家用户名分组  筛选内容：卖家用户名、成交笔数、支付宝成交金额
	 * @author longque.zs
	 * @param args
	 * @throws IOException
	 */
...
//		String input = "D:\\usr\\20121029"; // 文件路径
		String mainName="线下支付-教育培训"; //报表主名称
