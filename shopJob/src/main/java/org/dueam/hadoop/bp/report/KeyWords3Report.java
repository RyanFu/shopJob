...
public class KeyWords3Report {
    ...
    public static void main(String[] args) throws IOException {
        ...
        market.addCol("关键字").addCol("search-PV").addCol("search-UV").addCol("引导-PV").addCol("引导-UV").addCol("转化率")
                .addCol(
                Report.BREAK_VALUE);
        ...
        for (Entry<String, String[]> entry : lsMap.entrySet()) {
            ...
            market.addCol(key).addCol(ls[0]).addCol(ls[1]).addCol(ipv[0]).addCol(ipv[1]).addCol(
