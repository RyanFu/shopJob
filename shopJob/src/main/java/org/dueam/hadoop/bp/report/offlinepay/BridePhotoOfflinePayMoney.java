...
//===================================================================================
// File name: BridePhotoOfflinePayMoney.java
// Author: longque.zs
// Date: 2013-2-19 下午01:07:26 
// Description: 	 
// 		无
// Function List: 	 
// 		1. 无
...
public class BridePhotoOfflinePayMoney {


	private static char CTRL_A=(char)0x01; //分隔符
	/**
	 * 主要内容：
	 * 婚纱摄影类目线上小定成交排行榜(每天)：卖家用户名和宝贝id分组  筛选内容：卖家用户名、商品id、成交笔数、支付宝成交金额
	 * 婚纱摄影类目线下POS大定成交排行榜(每天)：卖家用户名和宝贝id分组  筛选内容：卖家用户名、商品id、成交笔数、支付宝成交金额
	 * 婚纱摄影类目2012年线上小定成交排行榜(每年)：卖家用户名分组  筛选内容：卖家用户名、成交笔数、支付宝成交金额
	 * 婚纱摄影类目2012年线下POS大定成交排行榜(每年)：卖家用户名分组  筛选内容：卖家用户名、成交笔数、支付宝成交金额
	 * 婚纱摄影类目2013年线上小定成交排行榜(每年)：卖家用户名分组  筛选内容：卖家用户名、成交笔数、支付宝成交金额
	 * 婚纱摄影类目2013年线下POS大定成交排行榜(每年)：卖家用户名分组  筛选内容：卖家用户名、成交笔数、支付宝成交金额
	 * @author longque.zs
	 * @param args
	 * @throws IOException
	 */
...
//		String input = "D:\\usr\\20121029"; // 文件路径
		String mainName="线下支付-婚纱摄影"; //报表主名称
