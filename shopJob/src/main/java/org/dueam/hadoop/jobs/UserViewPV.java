 ...
 * Date: 11-1-4 下午1:14
 */
public class UserViewPV extends Configured implements Tool, Reducer<Text, Text, Text, Text>, Mapper<Object, Text, Text, Text> {
    ...
    protected String getOutputPath(String[] args) {
        return "/group/tbdev/xiaodu/suoni/user_view_pv/" + args[0];
    }
    ...
    protected void doWork(String line, OutputCollector<Text, Text> output) throws IOException {
        ...
        output.collect(new Text(userId), new Text(mid));
