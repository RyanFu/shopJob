 ...
 * Date: 11-4-7 上午9:36
 */
public abstract class Merge extends Configured implements Tool,Mapper<Object, Text, Text, LongWritable>, Reducer<Text, Text, Text, Text> {
