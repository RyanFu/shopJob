 ...
 */
public class RefundAvgTimeMonth extends MapReduce<Text, Text> {


    @Override
    protected void setup(String[] args) {
        this.output = "/group/tbdev/xiaodu/suoni/refund_avg_time_month/" + args[0];
    ...
    public void map(Object key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
        ...
        if(gmtModified.compareTo(DateStringUtils.add(queryDate,-30) + " 00:00:00")< 0){
            return;
        }
