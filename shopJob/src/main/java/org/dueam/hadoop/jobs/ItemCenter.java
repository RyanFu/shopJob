 ...
 * 追踪多天新发布商品的增长情况
 */
public class ItemCenter extends SimpleMapReduce {
    @Override
    ...
    protected String getOutputPath(String[] args) {
        return "/group/tbdev/xiaodu/suoni/item_center/" + args[0];
    ...
    protected void doWork(String line, OutputCollector<Text, LongWritable> output) throws IOException {
        ...
        output.collect(Utils.mergeKey("db_category_"+_allCols[AuctionAuctions.AUCTION_STATUS], categoryId), ONE);
